...
declare class NRF {
  ...
  static on(
    event: 'advertising',
    callback: (isAdvertising: boolean) => void
  ): void;
  ...
  static findDevices(
    ...
    options?:
      | number
      | { filters?: NRFFilters[]; timeout?: number; active?: boolean }
  ): void;
...
declare class Bangle {
  static removeListener(event: string, callback: (...params) => void): void;
  /**
  ...
  static on(
    event: 'GPS-raw',
    callback: (nmea: string, dataLoss: boolean) => void
  ): void;
  ...
  static on(
    event: 'stroke',
    callback: (event: { xy: Uint8Array; stroke?: string }) => void
  ): void;
   ...
   */
  static project(latlong: { lat: number; lon: number }): {
    x: number;
    y: number;
  };
...
declare class Graphics<IsBuffer extends boolean = boolean> {
   ...
   */
  blendColor(
    col_a: ColorResolvable,
    col_b: ColorResolvable,
    amt: number
  ): number;
   ...
   */
  setTheme(theme: {
    [key in keyof Theme]?: Theme[key] extends number
      ? ColorResolvable
      : Theme[key];
  }): Graphics;
}
...
declare class E {
  ...
  static showMessage(
    message: string,
    title?: string | { title?: string; img?: string }
  ): void;
  ...
  static on(
    event: 'errorFlag',
    callback: (errorFlags: ErrorFlag[]) => void
  ): void;
  ...
  static on(
    event: 'touch',
    callback: (x: number, y: number, b: number) => void
  ): void;
...
declare function setWatch(
  func:
    | ((arg: { state: boolean; time: number; lastTime: number }) => void)
    | string,
  pin: Pin,
  options?:
    | boolean
...
declare function require(
  moduleName: 'TelnetServer'
): typeof import('TelnetServer');
